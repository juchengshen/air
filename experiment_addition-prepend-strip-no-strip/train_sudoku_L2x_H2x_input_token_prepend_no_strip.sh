...
OMP_NUM_THREADS=8 python pretrain.py \
  ...
  +seed=0 \
  +project_name=Sudoku_new \
  +run_name=air_L2x_H2x_input_token_prepend_no_strip_lr1e4_bs768_20k_epochs_run1 \
  arch.name=air.air_1net_L2x_H2x_input_token_prepend_no_strip@AIR
